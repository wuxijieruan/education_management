...
export default {
  ...
  methods: {
    ...
    pictureBookType() {
      var type = this.pictureBookShow;
      if (type) {
        this.pictureBookShow = false;
      } else {
