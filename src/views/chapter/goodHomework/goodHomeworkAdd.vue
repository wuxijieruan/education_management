<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right" style="margin-bottom:10px;">
      ...
      <el-breadcrumb-item>优秀作业新增</el-breadcrumb-item>
    </el-breadcrumb>
...
<script>
import { excellentHomeworkAdd, chapterExercisesGet } from "@/api/getData";
  ...
  methods: {
    ...
    submitAdd(formName) {
      ...
      this.$refs[formName].validate(async valid => {
        if (valid) {
          const res = await excellentHomeworkAdd(this.form);
