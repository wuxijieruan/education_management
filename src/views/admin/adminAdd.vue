      ...
      <div class="fromm">
        ...
        >
          ...
          <el-form-item label="密码" prop="userPassword">
            <el-input v-model="ruleForm.userPassword" type="password" placeholder="请输入密码"></el-input>
          </el-form-item>
          <el-form-item label="确认密码" prop="confirmpassword">
            <el-input v-model="ruleForm.confirmpassword" type="password" placeholder="请输入密码"></el-input>
          </el-form-item>
...
<script>
import { adminAdd } from "@/api/getData";
export default {
  data() {
    return {
      ruleForm: {
    ...
    submitForm(formName) {
      this.$refs[formName].validate(async valid => {
        if (valid) {
          ...
          if (this.ruleForm.userPassword == this.ruleForm.confirmpassword) {
            console.log(this.ruleForm);
            const res = await adminAdd(this.ruleForm);
            console.log(res);
            if (res !== "error") {
              this.$message({
                message: "提交成功",
