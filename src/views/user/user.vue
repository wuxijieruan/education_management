    ...
    >
      ...
      >
        ...
        <el-form-item label="手机号" prop="phone">
          <el-input v-model="form.phone" style="width: 36%"></el-input>
        </el-form-item>
        <el-form-item label="用户身份" prop="studentIdentity">
          <el-select
            v-model="form.studentIdentity"
            placeholder="请选择用户身份"
          >
        ...
        <el-form-item label="注册时间">
          <el-date-picker
            ...
            v-model="form.startStuCreateTime"
            type="date"
...
export default {
  ...
  methods: {
    ...
    searchuser() {
      if (this.form != []) {
        if (
          (this.form.startStuAge != undefined &&
            this.form.startStuAge != "") ||
          (this.form.endStuAge != undefined &&
            this.form.endStuAge != "")
        ) {
          //起始和截止但凡有一项有值
          var issttrue = 0;
          if (
            ...
            if (
              this.form.startStuAge > 0 &&
              this.form.startStuAge < 105
            ) {
              issttrue = 1;
              //console.log("比大小正确1");
            } else {
          ...
          if (
            ...
            if (
              this.form.endStuAge > 0 &&
              this.form.endStuAge < 105
            ) {
              isentrue = 1;
            //  console.log("比大小正确2");
            } else {
          ...
          if (issttrue == 1 && isentrue == 1) {
            //控制起始年龄比终止小
            if (this.form.startStuAge <= this.form.endStuAge) {
             // console.log("比大小正确12");
            } else {
              alert("请正确填写年龄区间");
              return;
        ...
        if (
          this.form.startStuCreateTime != undefined &&
          this.form.endStuCreateTime != undefined
        ) {
          let st = new Date(this.form.startStuCreateTime);
          let en = new Date(this.form.endStuCreateTime);
    ...
    async getenterprise(e) {
      // const resss = await getMessList(this.form);
