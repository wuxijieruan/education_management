    ...
    >
      ...
      <el-form-item label="课程所需积分" prop="unlockPoints">
        ...
        ></el-input>
          ...
          <el-form-item label="课程默认显示类别" prop="defaultCategory">
            <el-select v-model="form.defaultCategory" placeholder="请选择默认显示页面">
              <el-option value="1" label="快捷注册">父母导读</el-option>
              <el-option value="2" label="完整注册">心选绘本</el-option>
               <el-option value="3" label="完整注册">精彩解读</el-option>
                <el-option value="4" label="完整注册">脑洞时间</el-option>
            </el-select>
          </el-form-item>
