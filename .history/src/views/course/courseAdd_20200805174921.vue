        ...
        ></el-input>
          ...
          <el-form-item label="默认显示类别" prop="defaultCategory">
            <el-select v-model="form.defaultCategory" placeholder="请选择默认显示页面">
              <el-option value="1" label="快捷注册">快捷注册</el-option>
              <el-option value="2" label="完整注册">完整注册</el-option>
               <el-option value="3" label="完整注册">完整注册</el-option>
                <el-option value="4" label="完整注册">完整注册</el-option>
            </el-select>
          </el-form-item>
